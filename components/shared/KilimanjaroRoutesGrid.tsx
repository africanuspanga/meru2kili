...
import { Clock, Mountain, ArrowRight, Tent, CalendarCheck } from "lucide-react";

interface KilimanjaroRoutesGridProps {
  routes: TripPackage[];
}

export default function KilimanjaroRoutesGrid({ routes }: KilimanjaroRoutesGridProps) {
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-sm text-gray-500 mb-6 line-clamp-3 flex-1">
                  {route.description ||
                    "Experience an unforgettable journey to the summit of Africa's highest peak with our expert guides."}
                </p>
