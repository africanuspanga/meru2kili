...
import { Clock, Mountain, Tent, Check, Info, CalendarDays, MapPin } from "lucide-react";
...
export default function RouteDetailClient({ route, category }: RouteDetailClientProps) {
            ...
            <AnimatedSection>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
                {[
                  ...
                  { icon: MapPin, label: "Peak", value: "5,895m" },
                ].map((item) => (
                ...
                <div className="space-y-4">
                  {route.itinerary.map((day, i) => (
                    <motion.div
                      key={`${day.day}-${i}`}
                      initial={false}
                      animate={{ height: activeDay === i ? "auto" : "auto" }}
              ...
              <AnimatedSection>
                <div className="bg-brand-green rounded-2xl p-6 text-white">
                  ...
                  <p className="text-sm text-white/80 mb-6">
                    Reserve your spot on the {route.title} and start your journey to the Roof of Africa.
                  </p>
                  <button
